...
#define RHEL_VERSION_GTE(a,b) (RHEL_RELEASE_CODE != 0 && RHEL_RELEASE_CODE >= RHEL_RELEASE_VERSION(a,b))
#define RHEL_VERSION_LTE(a,b) (RHEL_RELEASE_CODE != 0 && RHEL_RELEASE_CODE <= RHEL_RELEASE_VERSION(a,b))
#define RHEL_VERSION_LT(a,b) (RHEL_RELEASE_CODE != 0 && RHEL_RELEASE_CODE < RHEL_RELEASE_VERSION(a,b))
